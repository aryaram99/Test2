...
public class Alpha extends AppCompatActivity {
    ...
    void ambil_data()
    {
        String link="http://magangubd17.000webhostapp.com/alpha.php";
        StringRequest respon=new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Custom_adapter1 adapter=new Custom_adapter1(Alpha.this, list_data);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Alpha.this, "eror", Toast.LENGTH_SHORT).show();
...
class Get_data1{
    ...
    Get_data1( String id, String status, String nama, String tanggal)
    {
        this.id=id;
        this.status=status;
        this.nama=nama;
...
class Custom_adapter1 extends BaseAdapter
{

    Context context;
    LayoutInflater layoutInflater;
    ArrayList<Get_data1>model;
    Custom_adapter1(Context context, ArrayList<Get_data1> model)
    {
