...
public class Charlie extends AppCompatActivity {
    ...
    void ambil_data()
    {
        String link="http://magangubd17.000webhostapp.com/charlie.php";
        StringRequest respon=new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Custom_adapter3 adapter=new Custom_adapter3(Charlie.this, list_data);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Charlie.this, "eror", Toast.LENGTH_SHORT).show();
...
class Get_data3{
    ...
    Get_data3( String id, String status, String nama, String tanggal)
    {
        this.id=id;
        this.status=status;
        this.nama=nama;
...
class Custom_adapter3 extends BaseAdapter {

    Context context;
    LayoutInflater layoutInflater;
    ArrayList<Get_data3> model;

    Custom_adapter3(Context context, ArrayList<Get_data3> model) {
