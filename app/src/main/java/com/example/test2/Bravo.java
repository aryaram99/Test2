...
public class Bravo extends AppCompatActivity {
    ...
    void ambil_data()
    {
        String link="http://magangubd17.000webhostapp.com/bravo.php";
        StringRequest respon=new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Custom_adapter2 adapter=new Custom_adapter2(Bravo.this, list_data);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Bravo.this, "eror", Toast.LENGTH_SHORT).show();
...
class Get_data2{
    ...
    Get_data2( String id, String status, String nama, String tanggal)
    {
        this.id=id;
        this.status=status;
        this.nama=nama;
...
class Custom_adapter2 extends BaseAdapter {

    Context context;
    LayoutInflater layoutInflater;
    ArrayList<Get_data2> model;

    Custom_adapter2(Context context, ArrayList<Get_data2> model) {
